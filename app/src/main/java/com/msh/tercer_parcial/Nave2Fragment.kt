// Nave2Fragment.kt
package com.msh.tercer_parcial // Cambia a tu paquete base si es diferente, ej. com.maestrocorona.appferia
        ...
        return ComposeView(requireContext()).apply {
            ...
            setContent {
                MaterialTheme { // Envuelve tu Composable con tu tema de Material Design
                    Nave2Content() // Llamamos a la función Composable que define la UI de Nave2
                }
            }
        }
    }
...
// Función Composable que contiene la UI de Nave2, similar a cómo lo tenías en tu Activity.
// Ya no necesita onBackPressed directamente aquí si la navegación se maneja desde la actividad o NavController.
@Composable
fun Nave2Content() { // Cambiado de Nave2 a Nave2Content para evitar conflicto con la clase Fragment
    Surface(
